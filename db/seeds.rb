...
Book.create(title: "test1 again", user_id: 1, author_id: 4)
Book.create(title: "test2", user_id: 2, author_id: 2)
Book.create(title: "test2 again", user_id: 2, author_id: 5)
Book.create(title: "test3", user_id: 3, author_id: 3)
Book.create(title: "test3 again", user_id: 3, author_id: 6)